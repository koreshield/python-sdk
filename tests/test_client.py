...
from koreshield.async_client import AsyncKoreShieldClient
from koreshield.exceptions import AuthenticationError, ValidationError, RateLimitError
from koreshield.types import DetectionResult, ThreatLevel, DetectionType, DetectionIndicator
...
class TestKoreShieldClient:
    ...
    def test_rag_response_parses_backend_shape(self):
        ...
        from koreshield.types import RAGScanResponse
